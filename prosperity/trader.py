...
LIMITS = {"EMERALDS": 20, "TOMATOES": 200}

# EMERALDS 参数
EMERALD_FAIR = 10000
EMERALD_NORMAL_OFFSET = 8      # ± 8 — 成交密集档位
EMERALD_CUT_OFFSET = 7         # ± 7 — 头寸过大时的截胡档位
EMERALD_POS_HEAVY = 12         # |pos| > 12 触发截胡

# TOMATOES 参数
TOMATO_NORMAL_OFFSET = 7
TOMATO_MID_OFFSET = 6
TOMATO_EXTREME_OFFSETS = (1, 2)
TOMATO_POS_MID = 80            # |pos| > 80 进入 mid 档
TOMATO_POS_EXTREME = 160       # |pos| > 160 进入 extreme 档；该方向停吃
